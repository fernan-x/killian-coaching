...
import "./globals.css";
import Nav from "@/legacy/components/ui/nav";
import Footer from "@/legacy/components/section/footer";
import CookieConsent from "@/legacy/components/common/cookie-consent";
